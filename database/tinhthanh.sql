...
-- Dumping structure for table dictionary.districts
...
-- Dumping data for table dictionary.districts: ~713 rows (approximately)
...
-- Dumping structure for table dictionary.provinces
...
-- Dumping data for table dictionary.provinces: ~63 rows (approximately)
...
-- Dumping structure for table dictionary.wards
CREATE TABLE IF NOT EXISTS `wards` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) CHARACTER SET utf8 NOT NULL,
  `district_id` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=32249 DEFAULT CHARSET=latin1;

-- Dumping data for table dictionary.wards: ~11,195 rows (approximately)
DELETE FROM `wards`;
